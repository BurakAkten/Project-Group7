...
namespace motion {
    ...
    private:
        ...
        inline void stopMotion() const { digitalWrite(0,LOW); digitalWrite(1,LOW); }
        inline void startRightMotion() const { digitalWrite(0,HIGH); digitalWrite(1,LOW); }
        inline void startLeftMotion() const { digitalWrite(0,LOW); digitalWrite(1,HIGH); }
